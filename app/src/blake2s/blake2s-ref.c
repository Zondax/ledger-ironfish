/*
   Oficial BLAKE2 implementation tweak by Zondax AG
...
/* blake2s init with personalization */
int blake2s_init_with_personalization(blake2s_state *S, size_t outlen, const uint8_t *personalization,
                                      uint8_t personalizationlen) {
    blake2s_param P[1];
